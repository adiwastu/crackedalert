...
- Legacy MT5/bash stack deleted from the repo in 2.0.45 (listener/checker
  scripts, use_old/use_new switchers, deploy.sh, legacy systemd units,
  api.md, PLAN.md, MT5 doc sections, TSV-import bridge); deploy_v2.sh now
  best-effort disables any leftover legacy units on the VPS.
